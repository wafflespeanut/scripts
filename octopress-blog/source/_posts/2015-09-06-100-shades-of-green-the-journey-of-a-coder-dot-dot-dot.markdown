...
I got into IRC and discovered that they offered mentors for new users. I got one for myself, who even suggested me a "good first bug", which took me some days to finally submit a patch. That also required me to get into Ubuntu and a new DVCS called *Mercurial*. My first bug explained me how things worked over there. It also came with a perk - I never used Windows from then on! I realized the awesomeness of Ubuntu! [That was it](http://wp.me/p3OCmi-uA), and later bugs became a piece of cake, thanks to those awesome Mozillians.
